...
let servicosConcluidos: Array<object> = [];
...
const ServicosConcluidos = () => {
    ...
    async function pegaDados() {
        ...
        try {
            ...
            formData.append('acao', 'servicos_concluidos');
            ...
            if (response.status === 201) {
                const servicosConcluidosData = response.servAceitos;
                if (servicosConcluidos[0] === undefined) {

                    // Freelancer
                    if (userTipo === '0') {
                        servicosConcluidosData.map((servAceitos: any) => {
                            servicosConcluidos.push({
                                id: servAceitos.id,
    ...
    const listaServicos = servicosConcluidos.map((servico: any, index: any) =>
        <>
            {userTipo === "0" &&
                <li
